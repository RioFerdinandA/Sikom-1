...
<div class="sticky">
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            <div class="main-sidebar-loggedin">
                <div class="app-sidebar__user">
                    <div class="dropdown user-pro-body text-center">
                        <div class="user-pic">
                            <img src="{{ asset('assets') }}/img/faces/r.jpg" alt="user-img"
            ...
            <ul class="side-menu ">
                <li class="slide">
                    <a class="side-menu__item" href=""><i class="side-menu__icon fe fe-trending-up"></i><span
                            class="side-menu__label">Dashboard</span></a>
                <li class="slide">
                    <a class="side-menu__item {{ request()->is('buku') ? 'active' : '' }}"
                        href="{{ route('buku.index') }}"> <i class="side-menu__icon fe fe-airplay"></i><span
                            class="side-menu__label">Buku</span></a>
                </li>
            </ul>
